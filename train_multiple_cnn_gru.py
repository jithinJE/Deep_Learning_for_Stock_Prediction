...
if __name__=='__main__':
    ...
    for seq_len in seq_lens:
        ...
        model = KerasRegressor(build_fn=multiple_cnn_gru.build_model, validation_split = 0.20)
        ...
        for index, row in results.iterrows():
            ...
            top_model = multiple_cnn_gru.build_model(row['param_layers'], row['param_ksize1'], row['param_step_size'], row['param_lstm_units'], row['param_single_lstm_layer'])            
