...
if __name__=='__main__':
    ...
    description = 'single_cnn_bidir_gru'
	...
	#    ONLY SINGLE BRANCH   SO REMOVED IF CONDITION
        model = KerasRegressor(build_fn = single_cnn_bidir_gru.build_model, validation_split = 0.20)
	    ...
	    # ONLY SINGLE MODEL     SO REMOVED IF CONDITION

            top_model = single_cnn_bidir_gru.build_model(row['param_layers'], row['param_cnn_layers'], row['param_kernel_size'])
