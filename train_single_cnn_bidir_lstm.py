...
if __name__=='__main__':
    ...
    description = 'single_cnn_bidir_lstm'
    ...
    for seq_len in seq_lens:
        ...
        model = KerasRegressor(build_fn=single_cnn_bidir_lstm.build_model, validation_split = 0.20)
        ...
        for index, row in results.iterrows():
            ...
            top_model = single_cnn_bidir_lstm.build_model(row['param_layers'], row['param_cnn_layers'], row['param_kernel_size'])
